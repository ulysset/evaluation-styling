...
const Button = styled.button`
  ...
  ${(props) =>
    props.buttonType === "secondary" ? `background-color: rgb(224, 231, 255); color: rgb(67, 56, 202); ` : ""};
  ${(props) => (props.size === "big" ? `padding: 0.4rem 0.8rem; font-size: 1.25rem` : "")};
  ${(props) =>
    props.clicked ? `background-color: rgba(220, 38, 38); color: white; &:hover { background-color : orange;};` : ""};
  &:focus {
